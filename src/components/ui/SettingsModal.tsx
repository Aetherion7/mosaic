...
const BASE_CATS: { id: BaseCat; label: string; icon: React.ReactNode }[] = [
  ...
  { id: 'boards',           label: 'Boards',           icon: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="5" width="20" height="14" rx="2"/><rect x="4.5" y="7.5" width="6" height="4" rx="1"/><rect x="4.5" y="13.5" width="6" height="3" rx="1"/><rect x="12.5" y="7.5" width="7" height="9" rx="1"/></svg> },
