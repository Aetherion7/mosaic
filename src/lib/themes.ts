...
export const THEMES: ThemePreset[] = [
  ...
  },
  {
    ...
    cssVars: {
      ...
      '--shadow-color': '#000000',
      '--popover-bg':   'var(--surface)',
      // Overrides the all-themes default of white below: --accent here is
      // near-white (#f2f2f2), so icons/text drawn in the usual literal
      // 'white' on an accent-colored pill would be invisible against it.
      '--on-accent':    '#0a0a0a',
    },
